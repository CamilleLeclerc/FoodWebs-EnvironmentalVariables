...
##DATA##
top_models <- lapply(c("gam_dim1_extremevalueSDI_reduce_model.rds", "gam_dim2_extremevalueSDI_reduce_model.rds",
...
model_names = c("DIM 1 - SDI", "DIM 2 - SDI",
                "DIM 1 - DOC", "DIM 2 - DOC",
                "DIM 1 - Tmean", "DIM 2 - Tmean",
                "DIM 1 - Tseasonality", "DIM2 - Tseasonality")
